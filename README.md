...
```bash
git clone https://github.com/kowsalyarajalingam/car-price-prediction.git
...
│
├── kowsalya_Car_Price_Prediction.py     # ← Single-file Streamlit application
├── car price prediction.csv      # ← Dataset (download from Kaggle link above)
├── requirements.txt              # ← Python dependencies
├── README.md                     # ← This file
└── Car_Price_Prediction_kowsalya_ProjectReport.docx  # ← Structured project report
```
